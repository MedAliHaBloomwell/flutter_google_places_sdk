...
mixin _$PlaceAutocompleteStructuredFormat {
  ...
  $PlaceAutocompleteStructuredFormatCopyWith<PlaceAutocompleteStructuredFormat>
      get copyWith => _$PlaceAutocompleteStructuredFormatCopyWithImpl<
              PlaceAutocompleteStructuredFormat>(
          this as PlaceAutocompleteStructuredFormat, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(
                other.secondary_text_matched_substrings,
  ...
  int get hashCode => Object.hash(
      ...
      secondary_text,
      const DeepCollectionEquality().hash(secondary_text_matched_substrings));
...
abstract mixin class $PlaceAutocompleteStructuredFormatCopyWith<$Res> {
  factory $PlaceAutocompleteStructuredFormatCopyWith(
          ...
          $Res Function(PlaceAutocompleteStructuredFormat) _then) =
      _$PlaceAutocompleteStructuredFormatCopyWithImpl;
  @useResult
  $Res call(
      {String main_text,
  ...
  $Res call({
    ...
    return _then(_self.copyWith(
      ...
      main_text_matched_substrings: null == main_text_matched_substrings
          ? _self.main_text_matched_substrings
...
extension PlaceAutocompleteStructuredFormatPatterns
    on PlaceAutocompleteStructuredFormat {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlaceAutocompleteStructuredFormat value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PlaceAutocompleteStructuredFormat() when $default != null:
        return $default(_that.main_text, _that.main_text_matched_substrings,
            _that.secondary_text, _that.secondary_text_matched_substrings);
      case _:
        return orElse();
    }
  }
...
/// @nodoc
@JsonSerializable()
class _PlaceAutocompleteStructuredFormat
    implements PlaceAutocompleteStructuredFormat {
  const _PlaceAutocompleteStructuredFormat(
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlaceAutocompleteStructuredFormatCopyWith<
          _PlaceAutocompleteStructuredFormat>
      get copyWith => __$PlaceAutocompleteStructuredFormatCopyWithImpl<
          _PlaceAutocompleteStructuredFormat>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlaceAutocompleteStructuredFormatToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PlaceAutocompleteStructuredFormat &&
            (identical(other.main_text, main_text) ||
                other.main_text == main_text) &&
            const DeepCollectionEquality().equals(
...
/// @nodoc
abstract mixin class _$PlaceAutocompleteStructuredFormatCopyWith<$Res>
    implements $PlaceAutocompleteStructuredFormatCopyWith<$Res> {
  factory _$PlaceAutocompleteStructuredFormatCopyWith(
          _PlaceAutocompleteStructuredFormat value,
          $Res Function(_PlaceAutocompleteStructuredFormat) _then) =
      __$PlaceAutocompleteStructuredFormatCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String main_text,
    ...
    return _then(_PlaceAutocompleteStructuredFormat(
      main_text: null == main_text
          ...
          : main_text // ignore: cast_nullable_to_non_nullable
              as String,
      main_text_matched_substrings: null == main_text_matched_substrings
          ? _self._main_text_matched_substrings
          : main_text_matched_substrings // ignore: cast_nullable_to_non_nullable
              as List<PlaceAutocompleteMatchedSubstring>,
      secondary_text: null == secondary_text
          ? _self.secondary_text
      ...
      secondary_text_matched_substrings: freezed ==
              secondary_text_matched_substrings
          ? _self._secondary_text_matched_substrings
          : secondary_text_matched_substrings // ignore: cast_nullable_to_non_nullable
              as List<PlaceAutocompleteMatchedSubstring>?,
    ));
  }
