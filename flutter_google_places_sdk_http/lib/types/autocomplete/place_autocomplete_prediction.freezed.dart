...
mixin _$PlaceAutocompletePrediction {
  ...
  $PlaceAutocompletePredictionCopyWith<PlaceAutocompletePrediction>
      get copyWith => _$PlaceAutocompletePredictionCopyWithImpl<
              PlaceAutocompletePrediction>(
          this as PlaceAutocompletePrediction, _$identity);
...
abstract mixin class $PlaceAutocompletePredictionCopyWith<$Res> {
  factory $PlaceAutocompletePredictionCopyWith(
          ...
          $Res Function(PlaceAutocompletePrediction) _then) =
      _$PlaceAutocompletePredictionCopyWithImpl;
  @useResult
  $Res call(
      {String description,
...
class _$PlaceAutocompletePredictionCopyWithImpl<$Res>
  ...
  $PlaceAutocompleteStructuredFormatCopyWith<$Res> get structured_formatting {
    return $PlaceAutocompleteStructuredFormatCopyWith<$Res>(
        _self.structured_formatting, (value) {
...
extension PlaceAutocompletePredictionPatterns on PlaceAutocompletePrediction {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlacesAutocompletePrediction value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PlacesAutocompletePrediction() when $default != null:
        return $default(
            _that.description,
            _that.matched_substrings,
            _that.structured_formatting,
            _that.terms,
            _that.distance_meters,
            _that.place_id,
            _that.types);
      case _:
        return orElse();
...
class _PlacesAutocompletePrediction extends PlaceAutocompletePrediction {
  const _PlacesAutocompletePrediction(
  ...
  factory _PlacesAutocompletePrediction.fromJson(Map<String, dynamic> json) =>
      _$PlacesAutocompletePredictionFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlacesAutocompletePredictionCopyWith<_PlacesAutocompletePrediction>
      get copyWith => __$PlacesAutocompletePredictionCopyWithImpl<
          _PlacesAutocompletePrediction>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlacesAutocompletePredictionToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _PlacesAutocompletePrediction &&
            (identical(other.description, description) ||
                other.description == description) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class _$PlacesAutocompletePredictionCopyWith<$Res>
    implements $PlaceAutocompletePredictionCopyWith<$Res> {
  factory _$PlacesAutocompletePredictionCopyWith(
          _PlacesAutocompletePrediction value,
          $Res Function(_PlacesAutocompletePrediction) _then) =
      __$PlacesAutocompletePredictionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String description,
